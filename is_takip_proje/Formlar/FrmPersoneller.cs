...
namespace is_takip_proje.Formlar
{
    public partial class FrmPersoneller : Form
    {
        ...
        void personeller()
        {
            var degerler = from x in db.TblPersonel select new
        {
            x.ID,
            x.Ad,
            x.Soyad,
        ...
        private void BtnEkle_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            XtraMessageBox.Show("Personel başarıyla eklendi.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Question);
            personeller();
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            deger.Durum = false;
            db.SaveChanges();
            XtraMessageBox.Show("Personel başarıyla silindi, silinen personeller listesinden " +
