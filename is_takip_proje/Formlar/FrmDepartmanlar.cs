...
namespace is_takip_proje.Formlar
{
    public partial class FrmDepartmanlar : Form
    {
        ...
        void Listele()
        {
            var degerler = from x in db.TblDepartmanlar select new
        {
            x.ID,
            x.Ad
        };
    ...
    /*   void Listele()
        {
           var degerler = db.TblDepartmanlar.ToList();
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            XtraMessageBox.Show("Departman başarılı bir şekilde sistemden silindi.",
