...
namespace MvcFirmaCagri.Controllers
{
    ...
    public class DefaultController : Controller
    {
        ...
        public ActionResult AktifCagrilar()
        {
            ...
            var aktif_cagrilar = db.TblCagrilar.Where(x => x.Durum == true && x.CagriFirma == id).ToList();
            return View(aktif_cagrilar);
        }
        public ActionResult PasifCagrilar()
        {
            ...
            var pasif_cagrilar = db.TblCagrilar.Where(x => x.Durum == false && x.CagriFirma == id).ToList();
            return View(pasif_cagrilar);
        }
